...
class SpedPisCofins(models.Model):
    ...
    def registro0000(self):
        ...
        dt = self.date_start
        dta_s = '%s%s%s' %(str(dt.day).zfill(2),str(dt.month).zfill(2),
            str(dt.year))
        dt = self.date_end
        dta_e = '%s%s%s' %(str(dt.day).zfill(2),str(dt.month).zfill(2),
            str(dt.year))
